const STATUS_STYLES: Record<string, string> = {
  ...
  structured_safe: "bg-moss/15 text-moss border-moss/30",
  structured_low_confidence: "bg-brass/15 text-brass border-brass/30",
  review_required: "bg-ember/15 text-ember border-ember/30",
  blocked_unsupported: "bg-ink/10 text-ink border-ink/25",
